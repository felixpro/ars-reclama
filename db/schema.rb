...
ActiveRecord::Schema.define(version: 2019_09_21_235635) do
  ...
  create_table "customers", force: :cascade do |t|
    ...
    t.integer "therapies_num"
    t.integer "total_therapies"
  end
  ...
  create_table "historials", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["customer_id"], name: "index_historials_on_customer_id"
  end
  ...
  create_table "procedures", force: :cascade do |t|
    ...
    t.datetime "updated_at", null: false
    t.string "plan"
    t.string "conclusion1"
    t.string "conclusion2"
