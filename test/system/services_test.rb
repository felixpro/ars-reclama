...
class ServicesTest < ApplicationSystemTestCase
  ...
  test "creating a Service" do
    ...
    fill_in "Authorized", with: @service.authorized
    fill_in "Code", with: @service.code
    fill_in "Customer", with: @service.customer_id
    fill_in "Difference", with: @service.difference
    fill_in "Process", with: @service.process
    fill_in "Reclaimed", with: @service.reclaimed
